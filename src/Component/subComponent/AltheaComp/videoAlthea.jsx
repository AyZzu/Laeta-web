...
import "../AltheaComp/videoAlthea.css";
...
const VideoAlthea = ({ data }) => {
  useEffect(() => {
    AOS.init();
    AOS.refresh();
  }, []);

  const VideoAlthea = data.map((items, i) => {
    return (
  ...
  return (
    <div className="listVideoAlthea">
      <div className="wrapperListVideo">
        ...
        <div className="videoList">{VideoAlthea}</div>
      </div>
    </div>
  );
};

export default VideoAlthea;
