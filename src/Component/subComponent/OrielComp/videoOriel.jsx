...
import "../OrielComp/videoOriel.css";
...
const VideoOriel = ({ data }) => {
  useEffect(() => {
    AOS.init();
    AOS.refresh();
  }, []);

  const VideoOriel = data.map((items, i) => {
    return (
  ...
  return (
    <div className="listVideoOriel">
      <div className="wrapperListVideo">
        ...
        <div className="videoList">{VideoOriel}</div>
      </div>
    </div>
  );
};

export default VideoOriel;
